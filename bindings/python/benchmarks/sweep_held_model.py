    ...
    *, trials: int = TRIAL_COUNT, workers: int = 1, baseline_path: Path = BASELINE
    ...
    return {
        ...
        "comparison": {
            ...
            "naive_full_document_decode_validate_operations": baseline["workload"]["trials"],
            "held_full_document_decode_validate_operations": 1,
            "naive_wall_clock_seconds": baseline["execution"]["wall_clock_seconds"],
            "held_wall_clock_seconds": wall_seconds,
            "naive_trial_total_seconds": baseline["phases"]["trial_seconds"]["total_seconds"],
            "held_trial_total_seconds": phases["trial_seconds"]["total_seconds"],
            "naive_run_total_seconds": baseline["phases"]["run_seconds"]["total_seconds"],
            "held_parameter_run_total_seconds": phases["parameter_run_seconds"]["total_seconds"],
        },
        **machine_and_toolchains(),
    }
